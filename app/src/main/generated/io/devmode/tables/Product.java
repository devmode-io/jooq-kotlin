 ...
 */
package io.devmode.tables;


import io.devmode.Public;
import io.devmode.tables.records.ProductRecord;
...
public class Product extends TableImpl<ProductRecord> {
     ...
     */
    public final TableField<ProductRecord, Short> ID = createField(DSL.name("id"), SQLDataType.SMALLINT.nullable(false).identity(true), this, "");
    ...
    @Override
    public Identity<ProductRecord, Short> getIdentity() {
        return (Identity<ProductRecord, Short>) super.getIdentity();
    }
